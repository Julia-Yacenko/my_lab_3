...
int main(int argc, char * argv[]){
	...
	cout << "Пекарня" << endl << "1.Посмотреть меню" << endl << "2.Добавить изделие" << endl << "3.Убрать изделие из меню" << endl << "4.Выбрать изделие по названию" << endl << "5.Выбрать изделие по массе" << endl << "6.Найти изделие по цене" << endl << "7.Выход" << endl;
	int c;
	cin >> c;
